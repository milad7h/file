...
$sql = "UPDATE rental SET area = '$area', rent = '$rent', mortgage = '$mortgage',hold='$hold',floors = '$floor',upf='$upf',unit='$unit',cold_heat = '$cold_heat',parking = '$parking',elevator = '$elevator',terrace = '$terrace',facades = '$facades',kitchen = '$kitchen',service =' $service',phone =' $phone',address = '$address',discription =' $discription', owner =' $owner' WHERE id = $id";
